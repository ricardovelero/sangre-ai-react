...
const editAnaliticaSchema = z.object({
  laboratorio: z
    .string()
    .min(1, { message: "Debes ingresar un laboratorio o dejarlo en N/D" }),
  medico: z
    .string()
    .min(1, { message: "Debes ingresar un médico o dejarlo en N/D" }),
  nombre: z.string().min(1, {
    message: "Debes ingresar un nombre de paciente o dejarlo en N/D",
  }),
  apellidos: z.string().min(1, {
    message: "Debes ingresar un apellido de paciente o dejarlo en N/D",
  }),
  fecha: z.string().min(1, {
    message: "Debes ingresar una fecha de la analítica o dejarlo en N/D",
  }),
});
