        ...
        <div className='mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:mt-10 lg:max-w-none lg:grid-cols-12'>
          <div className='relative lg:order-last lg:col-span-5'>
            ...
            <figure className='border-l border-primary pl-8'>
              <blockquote className='text-xl/8 font-semibold tracking-tight text-secondary-foreground'>
                <p>
              ...
              <figcaption className='mt-8 flex gap-x-4'>
                ...
                <div className='text-sm/6'>
                  ...
                  <div className='text-muted-foreground'>@brenna</div>
                </div>
              </figcaption>
            </figure>
          </div>
          <div className='max-w-xl text-base/7 text-muted-foreground lg:col-span-7'>
            ...
            <h2 className='mt-16 text-2xl font-bold tracking-tight text-accent-foreground'>
